...
<head>
    ...
    <link href="${dsq}/assets/css/dpl-min.css" rel="stylesheet" type="text/css" />
    <link href="${dsq}/assets/css/bui-min.css" rel="stylesheet" type="text/css" />
    <link href="${dsq}/assets/css/main-min.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<script type="text/javascript" src="${dsq}/assets/js/jquery-1.8.1.min.js"></script>
<script type="text/javascript" src="${dsq}/assets/js/bui-min.js"></script>
<script type="text/javascript" src="${dsq}/assets/js/common/main-min.js"></script>
<script type="text/javascript" src="${dsq}/assets/js/config-min.js"></script>
<script>
